describe('Проверка покупки нового аватара', function () {                 // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[id="k_email"]').type('anastacia.pokidko@yandex.ru');                   // вводим логин
         cy.get('input[id="k_password"]').type('Aloistransi2002');               // вводим пароль
         ...
         cy.get('.card_name').type('IVANOV IVAN');                           // вводим имя владельца действия карты
